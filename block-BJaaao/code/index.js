...
alert(`The sum of ${num1} and value of ${num2} is ${num1 + num2}`);
...
let isAdult = confirm("Are you 18 years old or more than 18 years?");
...
let numA = prompt("Tell me any number");
let numB = prompt("Tell me any other number");
